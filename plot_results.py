...
def plot_result(ax, path:str, plot_kwargs:dict=None, median=False, std=False, cumulative=True, 
                regret=True, minimize=False, xlim=None, degree=False, exploration=False, distance=False, sci=False):
...
def plot(exp_path, xlim):
    ...
    plot_result(axs[1], exp_path, std=True, cumulative=False, exploration=True, xlim=xlim)
